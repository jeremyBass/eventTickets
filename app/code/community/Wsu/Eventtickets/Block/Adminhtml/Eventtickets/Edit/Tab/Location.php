 ...
 * @link N/A 
 */
class Wsu_Eventtickets_Block_Adminhtml_Eventtickets_Edit_Tab_Location extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    /**
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend' => Mage::helper('wsu_eventtickets')->__('Location')
        ));
        ...
        Mage::dispatchEvent('adminhtml_eventtickets_edit_tab_location_prepare_form', array('form' => $form));
    ...
    public function getTabLabel()  {
        return Mage::helper('wsu_eventtickets')->__('Location info');
    }
